...
namespace Events_system.Repositories
{
    public class SystemRepository : ISystemRepository
    {
        ...
        public async Task<IEnumerable<Order>> GetAllOrdersAsync() =>
            await _context.Orders.Include(o => o.Tickets).Include(o => o.User).ToListAsync();
        public async Task<Order?> GetOrderByIdAsync(int id) =>
            await _context.Orders.Include(o => o.Tickets).Include(o => o.User).FirstOrDefaultAsync(o => o.Id == id);
        ...
        public async Task<IEnumerable<Queue>> GetAllQueuesAsync() =>
            await _context.Queues.Include(q => q.Ticket).Include(q => q.User).ToListAsync();
        public async Task<Queue?> GetQueueByIdAsync(int id) =>
            await _context.Queues.Include(q => q.Ticket).Include(q => q.User).FirstOrDefaultAsync(q => q.Id == id);
